  ...
  return (
    ...
    <div className='container'>
      ...
      <div id="calculator">
        ...
        <button id='divide' onClick={() => buttonPress("/")} className="green" >/</button>
        ...
        <button id='multiply' onClick={() => buttonPress("*")} className="green" >*</button>
        ...
        <button id='subtract' onClick={() => buttonPress("-")} className="green" >-</button>
        ...
        <button id='add' onClick={() => buttonPress("+")} className="green" >+</button>
